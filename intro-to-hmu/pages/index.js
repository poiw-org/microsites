            ...
            <div>
                ...
                <div className="container">
                    ...
                    <Alert variant="primary">
                      Αυτό το event θα γίνει διαδικτυακά. Θα πρέπει να γραφτείς για να έχεις πρόσβαση σε αυτό!
                    </Alert>
